...
\lambda=\frac{h}{p}\text{,}
$$
kde $\lambda$ je tzv. \emph{de Broglieho vlnová délka}\footnotemark[12], $p$ je hybnost 
...
%  \end{choices}
%\end{enumerate}
\noindent Zkuste najít a stručně popsat využiží de Broglieho teorie.
%</task>
\footnotetext[12]{V některých publikacích můžete najít i termín \emph{de Broglieova} vlnová délka}
\end{document}
