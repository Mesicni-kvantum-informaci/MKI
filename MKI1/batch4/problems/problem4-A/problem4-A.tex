...
V tomto seriálu jste se dozvěděli o \textit{Planckově vyzařovacím zákona}.
...
\footnotetext[2]{V češtině se právě často poměrně zmatečně nazývá jasnost.}
\footnotetext[3]{Česky by se správně mělo psát: Stefan\underline{ův}-Boltzmanův zákon – to nám však přijde opravdu uširvoucí.}
