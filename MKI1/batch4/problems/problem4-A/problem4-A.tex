...
Jak jasně hvězdu vidíme závisí na veličině, kterou nazýváme \textit{hustota zářivého toku}\footnote{V češtině se poměrně zmatečně může nazývat (bolometrická) jasnost.} a na vzdálenosti.
...
HZT dává do vztahu společne s teplotou tělesa \textit{Stefan-Boltzmannův zákon}.\footnote{V češtině by se správně mělo psát: Stefan\underline{ův}-Boltzmannův zákon – to nám však přijde opravdu uširvoucí.}
...
Chceme-li však porovnávat magnitudu nezávisle na vzdálenosti objektu, používáme tzv. \textit{absolutní magnitudu}.
...
Původně byly hvězdy rozděleny do sedmi skupin\footnote{Existuje mnoho vtipných pořekadel na zapomatování si všech tříd. Doporučujeme vám si je najít.}, kde každá skupina má deset podskupin.
...
Tento diagram se po nich nazývá \textit{Hertzsprung-Russelův diagram}.
